...
using UnityEngine;
using Unity.Collections; // Necesario para FixedString64Bytes
using TMPro;
...
public class NetworkPlayerInitializer : NetworkBehaviour
{
    ...
    [SerializeField] private TMP_Text nameText; // Texto para mostrar nombre en pantalla
    ...
    public override void OnNetworkSpawn()
    {
        ...
        // 🔁 Parte añadida: enviar y sincronizar nombre
        if (IsOwner && IsClient)
        {
